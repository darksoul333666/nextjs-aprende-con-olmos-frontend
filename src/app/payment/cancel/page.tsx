        ...
        <Card sx={{ p: 4, textAlign: 'center' }}>
          ...
          <Alert severity="info" sx={{ mb: 4, textAlign: 'left' }}>
            <Typography variant="body2">
              <strong>¿Por qué se canceló?</strong><br />
              • Cambiaste de opinión durante el proceso de pago<br />
              • Hubo un problema técnico temporal<br />
              • Decidiste usar un método de pago diferente
            </Typography>
          </Alert>
