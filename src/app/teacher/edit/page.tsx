...
export default function EditTeacherPage() {
  ...
  const [dialogType, setDialogType] = useState<
    "expertise" | "education" | "achievement"
  >("expertise");
  ...
  const handleRemoveItem = (
    type: "expertise" | "education" | "achievement",
    index: number,
  ) => {
    setFormData((prev) => {
      const updated = { ...prev };
      ...
      switch (type) {
        ...
        case "education":
          ...
          break;
        case "achievement":
          updated.achievements = updated.achievements?.filter(
            (_, i) => i !== index,
          );
          break;
      }
              ...
              >
                ...
                <Box flex={1} minWidth={300}>
                  <TextField
                    ...
                    InputProps={{
                      startAdornment: (
                        <Instagram sx={{ mr: 1, color: "text.secondary" }} />
                      ),
                    }}
                  />
                </Box>
                <Box flex={1} minWidth={300}>
                  <TextField
                    ...
                    InputProps={{
                      startAdornment: (
                        <Facebook sx={{ mr: 1, color: "text.secondary" }} />
                      ),
                    }}
                  />
                </Box>
              ...
              <CardContent>
                ...
                >
                  ...
                  {editMode && (
                    <IconButton
                      size="small"
                      onClick={() => openAddDialog("expertise")}
                    >
                      <Add />
                    </IconButton>
                  )}
              ...
              <CardContent>
                ...
                >
                  ...
                  {editMode && (
                    <IconButton
                      size="small"
                      onClick={() => openAddDialog("achievement")}
                    >
                      <Add />
                    </IconButton>
                  )}
                      ...
                      {editMode && (
                        <ListItemSecondaryAction>
                          <IconButton
                            ...
                            size="small"
                            onClick={() =>
                              handleRemoveItem("achievement", index)
                            }
                          >
                            <Delete />
                          </IconButton>
