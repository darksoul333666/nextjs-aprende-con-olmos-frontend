    ...
    return (
      <Box sx={{ minHeight: "100vh", backgroundColor: "#f8f9fa" }}>
        ...
        <Container maxWidth="lg" sx={{ py: 4 }}>
          <Alert severity="error">Solo los maestros pueden crear cursos.</Alert>
        </Container>
      </Box>
    );
  }
      ...
      <Container maxWidth="md" sx={{ py: 4 }}>
        ...
        <Paper sx={{ p: 4 }}>
          ...
          <Alert severity="info" sx={{ mb: 3 }}>
            Primero crea un borrador con la información básica del curso.
            Después podrás agregar secciones y videos.
          </Alert>
